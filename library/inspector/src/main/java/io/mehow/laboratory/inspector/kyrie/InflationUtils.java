...
import io.mehow.laboratory.inspector.kyrie.Animation.RepeatMode;
...
final class InflationUtils {
  ...
  static final TimeInterpolator DEFAULT_INTERPOLATOR =
  ...
  static class MyAnimatorSet extends MyAnimator {
  ...
  static class MyObjectAnimator extends MyAnimator {
  ...
  @NonNull
  static Map<String, List<Animation<?, ?>>> mergeMaps(
