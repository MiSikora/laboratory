 ...
 */
internal class Animation<T, V> private constructor(
    ...
    companion object {
        ...
        internal fun <V> ofObject(evaluator: ValueEvaluator<V>, values: Array<V>): Animation<V, V> {
            if (values.isEmpty()) {
        ...
        internal fun <V> ofObject(evaluator: ValueEvaluator<V>, values: Array<Keyframe<V>>): Animation<V, V> {
            if (values.isEmpty()) {
