...
@Size(multiple = 3)
internal fun approximate(path: Path, @FloatRange(from = 0.0) acceptableError: Float): FloatArray {
...
internal fun lerp(a: Float, b: Float, @FloatRange(from = 0.0, to = 1.0) t: Float): Float {
    return a + (b - a) * t
}
