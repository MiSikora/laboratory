...
import io.mehow.laboratory.inspector.kyrie.Node.Companion.asAnimation
import io.mehow.laboratory.inspector.kyrie.Node.Companion.asAnimations
import io.mehow.laboratory.inspector.kyrie.Node.Companion.replaceAnimations
import io.mehow.laboratory.inspector.kyrie.Node.Companion.replaceFirstAnimation
import org.xmlpull.v1.XmlPullParserException
import java.io.IOException

/** An animatable drawable based on scalable vector graphics. */
internal class KyrieDrawable(
    ...
    override fun setTintMode(tintMode: PorterDuff.Mode?) {
        if (this.tintMode != tintMode && tintMode != null) {
