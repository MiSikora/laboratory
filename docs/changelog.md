...
### Added
- `BlockingLaboratory.isEnabled()` convenience methods to interact with binary features.
...
### Fixed
- Broken POM declaration of the `laboratory-shared-preferences` uses non-existing dependencies.
...
[Unreleased]: https://github.com/MiSikora/laboratory/compare/2.0.3...HEAD
[2.0.3]: https://github.com/MiSikora/laboratory/releases/tag/2.0.3
[2.0.2]: https://github.com/MiSikora/laboratory/releases/tag/2.0.2
...
[1.0.0]: https://github.com/MiSikora/laboratory/releases/tag/1.0.0
