...
includeBuild("..") {
  dependencySubstitution {
    ...
    substitute(module("io.mehow.laboratory:laboratory-shared-preferences"))
      .using(project(":laboratory:shared-preferences"))
    substitute(module("io.mehow.laboratory:laboratory-data-store"))
      .using(project(":laboratory:data-store"))
    substitute(module("io.mehow.laboratory:laboratory-generator"))
      .using(project(":laboratory:generator"))
    substitute(module("io.mehow.laboratory:laboratory-gradle-plugin"))
      .using(project(":laboratory:gradle-plugin"))
    substitute(module("io.mehow.laboratory:laboratory-inspector"))
      .using(project(":laboratory:inspector"))
    substitute(module("io.mehow.laboratory:laboratory-hyperion-plugin"))
      .using(project(":laboratory:hyperion-plugin"))
  }
}
