...
internal fun TaskProvider<out Task>.contributeToSourceSets(
  dir: File,
  project: Project,
) {
...
internal fun TaskProvider<out Task>.contributeToAndroidSourceSets(
  dir: File,
  project: Project,
) {
  makeKotlinDependOnTask(project)
...
private fun TaskProvider<out Task>.contributeToAndroid(
  dir: File,
  project: Project,
) {
...
private val BaseExtension.variants: DomainObjectSet<out com.android.build.gradle.api.BaseVariant>
  get() = when (this) {
