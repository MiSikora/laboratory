...
public class SourcedFeatureStorageInput
internal constructor(packageNameProvider: PackageNameProvider) : Serializable {
  ...
  internal fun toModel(sourceNames: List<String>) =
