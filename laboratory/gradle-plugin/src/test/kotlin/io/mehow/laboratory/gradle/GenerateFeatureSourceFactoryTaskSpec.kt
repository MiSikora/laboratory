...
class GenerateFeatureSourceFactoryTaskSpec :
  FunSpec({
    ...
    test("uses implicit package name") {
      ...
      val factory =
        fixture.featureSourceStorageFile("io.mehow.implicit.GeneratedFeatureSourceFactory")
      factory.shouldExist()
    ...
    test("uses explicit package name") {
      ...
      val factory =
        fixture.featureSourceStorageFile("io.mehow.explicit.GeneratedFeatureSourceFactory")
      factory.shouldExist()
    ...
    test("generates internal factory") {
      ...
      factory.readText() shouldContain
        "internal fun FeatureFactory.Companion.featureSourceGenerated()"
    }
    ...
    test("generates public factory") {
      ...
      factory.readText() shouldContain
        "public fun FeatureFactory.Companion.featureSourceGenerated()"
    }
