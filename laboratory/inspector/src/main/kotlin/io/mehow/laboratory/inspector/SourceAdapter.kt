...
internal class SourceAdapter(private val features: List<Feature<*>>) : BaseAdapter() {
  override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
    val inflater = LayoutInflater.from(parent.context)
    val viewHolder =
      if (convertView == null) {
        val view =
          inflater.inflate(R.layout.io_mehow_laboratory_feature_source_spinner_item, parent, false)
  ...
  override fun getDropDownView(position: Int, convertView: View?, parent: ViewGroup): View {
    ...
    val viewHolder =
      if (convertView == null) {
        val view =
          inflater.inflate(
            R.layout.io_mehow_laboratory_feature_source_drop_down_item,
            parent,
            false,
          )
        SourceViewHolder(view as MaterialTextView).apply { view.tag = this }
