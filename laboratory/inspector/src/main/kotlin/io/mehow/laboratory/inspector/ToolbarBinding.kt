...
internal class ToolbarBinding(
  ...
  private val searchQuery =
    view.findViewById<AppCompatEditText>(R.id.io_mehow_laboratory_feature_query)
  private val openSearch =
    view.findViewById<ShapeableImageView>(R.id.io_mehow_laboratory_open_search)
  private val closeSearch =
    view.findViewById<ShapeableImageView>(R.id.io_mehow_laboratory_close_search)
  private val clearQuery =
    view.findViewById<ShapeableImageView>(R.id.io_mehow_laboratory_clear_query)
  private val resetFeatures =
    view.findViewById<ShapeableImageView>(R.id.io_mehow_laboratory_reset_features)

  private val resetFeaturesDialog =
