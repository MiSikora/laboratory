...
@JvmOverloads
constructor(context: Context, attrs: AttributeSet, defStyle: Int = AppCompatR.attr.spinnerStyle) :
  ...
  private fun createListener() =
    object : OnItemSelectedListener {
      ...
      override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
        ...
        val item = requireNotNull(adapter) { "Feature source adapter is not set" }.getItem(position)
