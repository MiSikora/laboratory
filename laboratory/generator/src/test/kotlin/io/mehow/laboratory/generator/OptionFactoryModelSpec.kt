...
class OptionFactoryModelSpec :
  FunSpec({
      ...
      val features =
        listOf(
          ...
          FeatureFlagModel(
            ...
            options =
              listOf(FeatureFlagOption("ThreeA", isDefault = true), FeatureFlagOption("ThreeB")),
            key = "FeatureC",
          ),
        )
      val model =
    ...
    test("is optimized when there are no features") {
      val model =
        OptionFactoryModel(ClassName("io.mehow", "GeneratedOptionFactory"), features = emptyList())
    ...
    test("suppresses usage of deprecated features") {
      ...
      val model = OptionFactoryModel(ClassName("io.mehow", "GeneratedOptionFactory"), features)
